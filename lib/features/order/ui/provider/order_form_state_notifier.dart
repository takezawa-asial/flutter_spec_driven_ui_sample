...
class OrderFormStateNotifier extends _$OrderFormStateNotifier {
  ...
  Future<Order> fetch(String orderId) async {
    ...
    //   items: const [
    //     OrderItem(sku: 'SKU-TSHIRT', name: 'T-Shirt', unitPrice: 2000, quantity: 1, stock: Stock.inStock),
    //   ],
    ...
    //   paymentMethod: PaymentMethod.bank, // 銀行振込を選ぶと不可（validationErrorsに理由が入る）
    //   items: const [
    //     OrderItem(sku: 'SKU-MUG', name: 'Mug', unitPrice: 1200, quantity: 1, stock: Stock.limited),
    //   ],
    ...
    //   paymentMethod: PaymentMethod.card,
    //   items: const [
    //     OrderItem(sku: 'SKU-TSHIRT', name: 'T-Shirt', unitPrice: 2000, quantity: 1, stock: Stock.soldOut),
    //   ],
    ...
    //   items: const [
    //     OrderItem(sku: 'SKU-COFFEE', name: 'Coffee Beans', unitPrice: 1500, quantity: 2, stock: Stock.inStock),
    //   ],
    ...
    //   items: const [
    //     OrderItem(sku: 'SKU-GAME', name: 'New Game', unitPrice: 6800, quantity: 1),
    //   ],
    ...
    //   items: const [
    //     OrderItem(sku: 'SKU-ALBUM', name: 'Limited Album', unitPrice: 3200, quantity: 1),
    //   ],
